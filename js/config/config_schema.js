...
WF88_M: {
    ...
    { varNo: 3, name: "STA_MAC_ADDR", group: "System", control: "text", defaultValue: "", range: "MAC", description: "Permanent Station MAC address assigned during production." },
    { varNo: 23, name: "DebugInfo", group: "System", control: "bool", defaultValue: "false", range: "bool", description: "Legacy persistent debug output control." },
    { varNo: 24, name: "TestMode", group: "System", control: "bool", defaultValue: "false", range: "bool", description: "Network data test mode." },
    ...
    { varNo: 21, name: "ATReply", group: "UART", control: "readonly", ro: true, defaultValue: "AT-WF ", range: "Read only", description: "AT response prefix (legacy parameter)." },
    ...
    { varNo: 28, name: "DeviceMode", group: "WiFi Network", control: "select", defaultValue: "STA", options: ["STA", "AP", "AP-STA", "MP", "AP-MP"], range: "STA, AP, AP-STA, MP, AP-MP", description: "Operation mode: Station (Client), Access Point, or mixed modes." },
    ...
    { varNo: 32, name: "AutoJoin", group: "WiFi Network", control: "readonly", ro: true, defaultValue: "0", range: "Read only", description: "Legacy STA auto-rejoin switch." },
    ...
    { varNo: 37, name: "Dtim", group: "WiFi Network", control: "readonly", ro: true, defaultValue: "0", range: "Read only", description: "WiFi DTIM period configuration." },
    ...
    { varNo: 71, name: "MQTTParamCfgEn", group: "MQTT Client", control: "readonly", ro: true, defaultValue: "0", range: "Read only", description: "Enable MQTT remote parameter configuration." },
    ...
    { varNo: 72, name: "NetworkCapacity", group: "Mesh", control: "number", defaultValue: "20", min: 1, max: 255, range: "1 - 255", description: "Mesh network capacity limit." },
    { varNo: 73, name: "CascadeMaxHop", group: "Mesh", control: "number", defaultValue: "3", min: 1, max: 15, range: "1 - 15", description: "Mesh cascade maximum hop limit." },
